...
const CompanyInfo = (props: any) => {
  ...
  useEffect(() => {
    if (company && user) {
      const isUserFollowing = company.usersFollowed?.some(
  ...
  const handleClick = async (e: any) => {
    ...
    if (isFollow) {
      ...
      setCompany((prev: any) => {
        return {
          ...prev,
          usersFollowed: prev?.usersFollowed?.filter(
            (item: any) => item.id.toString() !== user.id.toString()
          ),
        };
      });
            ...
            <div className={cx("company-detail")}>
              <div className={cx("box-detail")}>
                ...
                <div className={cx("users-follow")}>
                  ...
                  <span>{company?.usersFollowed?.length} người theo dõi</span>
                </div>
              </div>
            </div>
